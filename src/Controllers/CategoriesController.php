...
use Albertoesquitino\Ticketit\Requests\PrepareCategoryRequest;
use App\Http\Controllers\Controller;
use Albertoesquitino\Ticketit\Models\Category;
...
class CategoriesController extends Controller {
    ...
    public function store(PrepareCategoryRequest $request)
    {
        ...
        return redirect()->action('\Albertoesquitino\Ticketit\Controllers\CategoriesController@index');
    }
