...
use Albertoesquitino\Ticketit\Requests\PrepareStatusRequest;
use App\Http\Controllers\Controller;
use Albertoesquitino\Ticketit\Models\Status;
...
class StatusesController extends Controller {
    ...
    public function store(PrepareStatusRequest $request)
    {
        ...
        return redirect()->action('\Albertoesquitino\Ticketit\Controllers\StatusesController@index');
    }
